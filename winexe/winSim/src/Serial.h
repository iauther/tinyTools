...
public:
	...
	bool Setup(DWORD dwBaudRate = BaudRate115200, BYTE dwByteSize = DataBits8, BYTE dwParity = ParityNone, BYTE dwStopBits = StopOne);
...
protected:
    inline bool SetTimeouts(DWORD r_ms = 10, DWORD w_ms = 10);		//MAXWORD
    inline bool SetMask();
